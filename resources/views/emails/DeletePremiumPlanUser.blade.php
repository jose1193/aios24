                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        Queremos informarte que el plan
                                                                        <strong> {{ $planName }}</strong> en
                                                                        <strong>
                                                                            Real </strong>Estate ha sido
                                                                        cancelado exitosamente. Como resultado de esta
                                                                        cancelación, todos los anuncios asociados a este
                                                                        plan han sido eliminados permanentemente.

                                                                        <br><br>
                                                                        Agradecemos tu confianza en nuestros servicios y
                                                                        lamentamos que hayas decidido cancelar tu plan.
                                                                        Si en el futuro deseas volver a utilizar
                                                                        nuestros servicios, estaremos encantados de
                                                                        ayudarte.
                                                                        <br><br>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                                                                                    ...
                                                                                    <a href="https://aiosrealestate.com/myplans"
                                                                                        target="_blank"
