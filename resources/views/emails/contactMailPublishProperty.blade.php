                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                    align="left">
                                                                    <img class="w-40"
                                                                        src="https://www.aiosrealestate.com/img/logo2.png"
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class=""
                                                                        ...
                                                                        align="left">
                                                                        Nos complace informarte que has registrado un
                                                                        nuevo anuncio en nuestro sitio web. Tu anuncio
                                                                        ya ha sido publicado y se encuentra disponible
                                                                        en nuestro listado de anuncios
                                                                        publicados.<br><br>

                                                                        <strong>Título Publicación:
                                                                            {{ $title }}</strong><br><br>

                                                                        <strong>Código Anuncio:
                                                                            {{ $message2 }}</strong><br><br>

                                                                        Te invitamos a acceder al sitio para explorar
                                                                        los planes disponibles que te permitirán
                                                                        aumentar la exposición de tu anuncio y obtener
                                                                        mayores beneficios. Estos planes te brindarán
                                                                        una mayor visibilidad en la página de resultados
                                                                        de búsqueda y te ayudarán a llegar a un público
                                                                        más amplio interesado en tu propiedad.
                                                                        <br><br>
                                                                        ¡No pierdas la oportunidad de destacar tu
                                                                        anuncio y maximizar tus posibilidades de éxito!
                                                                        <br><br>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; border-radius: 6px; font-weight: 700 !important; margin: 0;"
                                                                                    ...
                                                                                    <a href="https://aiosrealestate.com/published"
                                                                                        target="_blank"
