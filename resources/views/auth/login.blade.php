        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
            ...
            <form method="POST" action="{{ route('login') }}" class="mx-auto max-w-lg rounded-lg border">
                ...
                <div class="flex flex-col gap-4 p-4 md:p-8">
                    ...
                    <button type="submit"
                        class="block rounded-lg bg-green-600 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-green-300 transition duration-500 ease-in-out hover:bg-green-700 focus-visible:ring active:bg-green-600 md:text-base">
