                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="w-full divide-y divide-gray-200 text-center">
                            <thead class="bg-green-600 text-white font-bold capitalize">
                                ...
                                <th class="px-4 py-2">Island</th>
                                <th class="px-4 py-2">Date</th>
                                <th class="px-4 py-2">Action</th>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr></tr>
                                @forelse($communities as $data)
                                    <tr>
                        ...
                        <div class="m-2 p-2">{{ $communities->links() }}</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                        <form enctype="multipart/form-data" autocomplete="off">
                            <div class="sm:col-span-6 mb-5">
                                ...
                                <select wire:model.lazy="province_id" id="province_id" name="province_id"
                            ...
                            <div class="sm:col-span-6">
                                <label for="exampleFormControlInput1"
                                    class="block text-gray-700 text-sm font-bold mb-2">Island:</label>
                                <div class="mt-1">
            ...
            Livewire.on('deleteData', catId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('communityprovinces', 'delete', catId)
                        Swal.fire(
                            'Deleted!',
