                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="w-full divide-y divide-gray-200 text-center">
                            <thead class="bg-green-600 text-white font-bold capitalize">
                                ...
                                <th class="px-4 py-2">Estatus Ads</th>
                        ...
                        <div class="m-2 p-2">{{ $estatus->links() }}</div>
                    </div>
                </div>
            </div>
                        ...
                        <form enctype="multipart/form-data" autocomplete="off">
                            <div class="sm:col-span-6">
                                <label for="exampleFormControlInput1"
                                    class="block text-gray-700 text-sm font-bold mb-2">Estatus Ads:</label>
                                <div class="mt-1">
                                    <input type="text" id="estatus_description" wire:model.lazy="estatus_description"
                                        name="estatus_description"
                                        class="block w-full 
            ...
            Livewire.on('deleteData', catId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('estatus-anuncios', 'delete', catId)
                        Swal.fire(
                            'Deleted!',
