                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @forelse($contactforms as $contact)
                                    <tr>
                                        ...
                                        <td>
                                            <x-button wire:click="showEditDataModal({{ $contact->id }})">
                                            ...
                                            <x-button-delete wire:click="$emit('deleteData',{{ $contact->id }})">
                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-full mt-10">
                        <form enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text" id="phone" wire:model="phone" name="phone"
                                        class="block w-full 
                                     appearance-none bg-white border
                                      border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 mb-2" />
                                </div>
                            ...
                            <div class="sm:col-span-6 pt-5">
                                ...
                                <div class="mt-1">
                                    <textarea rows="3" wire:model.lazy="message" id="message" name="message"
            ...
            Livewire.on('deleteData', catId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('contactforms', 'delete', catId)
                        Swal.fire(
                            'Deleted!',
