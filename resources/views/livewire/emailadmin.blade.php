            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 capitalize">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="w-full divide-y divide-gray-200 text-center">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @forelse($emails as $email)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $email->id }}</td>
                                        ...
                                        <td>
                                            <x-button wire:click="showEditDataModal({{ $email->id }})">
                                            ...
                                            <x-button-delete wire:click="$emit('deleteData',{{ $email->id }})">
                        ...
                        <div class="m-2 p-2">{{ $emails->links() }}</div>
                    </div>
                </div>
            </div>
            ...
            Livewire.on('deleteData', catId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('emailadmin', 'delete', catId)
                        Swal.fire(
                            'Deleted!',
